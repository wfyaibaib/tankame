...
{
//     qDebug() <<  " ItemsPool::addItemByType!" ;
...
void ItemsPool::setServerOrClient(ItemsPool::server_or_client_enum which)
{
    server_or_client = which;
}
